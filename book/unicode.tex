...
characters with combining diacritics. Splitting by code points (i.e. \texttt{sep~=~""}) shows the results of these two normalizations.
...
\hlcom{# NFD normalization gives yet another structure of the code points}
