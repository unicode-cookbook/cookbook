...
# does not work nice for non-R code (due to Highlight package),
# so currently set to FALSE in opts_chunk below
# knit_theme$set("acid")
...
\Sexpr{knit_child("chapters/orthography_profiles.tex")}
