...
supports Tamil, e.g. \textsc{tamil letter au} at \uni{0B94} represents a single 
...
Sinhala \textsc{sinhala vowel sign kombu deka} at \uni{0DDB} <ෛ>, which is 
...
the Unicode Core Specification~\citet{Unicode2017}. 
