...
% Consequently, a central goal of this book is to flesh out the linguistic-specific challenges regarding Unicode Locales  and to work out suggestions to simply their structure for usage in a linguistic context. We also aim to improve linguists' understanding and appreciation for the accomplishments of the Unicode Consortium in the development of the Unicode Standard.
