...
\end{comment}
	...
	\item \textsc{Metadata should be added in a separate UTF-8 text file} using 
	   ...
	   (iv) a stable language identifier of the target language of the profile
...
\begin{enumerate}
	...
	\item \textsc{The columns \texttt{Grapheme}, \texttt{Left} and \texttt{Right}
       ...
       used, then the must be specified in the metadata file as such, 
	...
	\item \textsc{Any other columns can be added freely, but will mostly be ignored
       ...
       columns, like for example Unicode code points, Unicode names, frequency of
