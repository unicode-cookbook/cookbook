...
\begin{itemize}
   ...
   \item According to the IPA, <ʰ> can be used both as <\dia{02B0}> for
         ...
         <\diareverse{02B0}> for pre-aspiration (preceding the base character).
         Note that there is yet another homoglyph, namely the
         \textsc{combining latin small letter h} at \uni{036A}. We propose not
         to use this combining diacritical mark, but to standardize on Unicode
         modifier letters for all superscript letters in IPA.
