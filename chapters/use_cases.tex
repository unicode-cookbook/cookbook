...
orthography profiles. These include: \begin{itemize}
	\item tokenization and error checking \item normalization of
	orthographic systems to attain interoperability across different source
	documents, \item cognate identification for detecting the similarity
...
- Unicode character tokenization - grapheme tokenization - tailored grapheme
tokenization
...
% insert some examples of creating a table of language | grapheme, language |
orthographic contexts % any measure of writing systems complexity?
...
%
({[}a\textbar{}á\textbar{}e\textbar{}é\textbar{}i\textbar{}í\textbar{}o\textbar{}ó\textbar{}u\textbar{}ú{]})(n)(\s)({[}a\textbar{}á\textbar{}e\textbar{}é\textbar{}i\textbar{}í\textbar{}o\textbar{}ó\textbar{}u\textbar{}ú{]}),
\1 \2 \4
...
\section{Diacritics: Unicode letter modifiers
(Lm)}\label{diacritics-unicode-letter-modifiers-lm}
