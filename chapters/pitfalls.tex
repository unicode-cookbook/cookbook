...
two-story <{\fontspec{Times New Roman}a}> changes to a single-story a in italics
...
Summerizing the pitfalls discussed in this chapter, we propose the following 
recommendations:
...
\begin{itemize}
   ...
   \item As a preferred file format, use UTF-8 in NFC without BOM with 
         LF line breaks, whenever possible (see 
         Section~\ref{pitfall-file-formats}). This nicely cryptic recommendation 
         has the T-shirt potential:
