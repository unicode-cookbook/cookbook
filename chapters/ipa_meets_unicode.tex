...
% this has to be revised: there are two issues: homoglyphs and alternative 
encoding options. that is not necessarily the same. Also include minor group break 
vs. dental click problem. and stress vs. ejective?
