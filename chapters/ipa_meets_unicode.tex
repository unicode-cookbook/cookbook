...
\noindent Some problematic homoglyphs related to encoding IPA in the Unicode Standard are 
the following.
\begin{itemize}
  ...
  \item The uses of the apostrophe has led to long discussions on the Unicode
     ...
     curly quotes, depending on the whitespace around it. Such a replacement is 
     a real character replacement, meaning that another Unicode code point is 
     inserted.} However, the glottal stop/glottalization/ejective marker is yet 
...
But even among linguists this distinction leads to problems. For example, as
