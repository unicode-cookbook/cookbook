...
using any of these elements, like <ɲ>, <ɳ>, <ɨ>, <ø> or <ɫ>. However, all 
...
some ad-hoc decisions had to be taken. For example, when a character sequence
...
Finally, if a character sequence contains more than one diacritic above the base
character, we propose the following order, with Spacing Modifiers and tone
letters being added at the end:
