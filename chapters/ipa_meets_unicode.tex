...
Many of the current problems derive from the fact that the
...
Chapter~\ref{orthography-profiles}). Note that there is an alternative 
homoglyph, namely the \textsc{combining latin small letter h} at \uni{036A}. We 
propose not to use this combining diacritical mark, but to standardize on 
Unicode modifier letters for all superscript letters in IPA.
